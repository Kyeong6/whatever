...
| 4 | 알림 | 이상치일 경우 JSON 파일 형식으로 전달(아래는 예시)<br>{<br>”sensor_id” : "sensor_01"<br>”time” : 2024-07-09 0:01,<br>”outlier_stage” : 3,<br>”value” : 227<br>}<br>(machine_number 같은 경우 중앙 서버에서 구별할 수 있으면 제거) |
